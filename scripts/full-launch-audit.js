 ...
 *
 * Usage:
 *   node scripts/full-launch-audit.js <service-account.json> <stripe-readonly-key.txt>
 *
...
if (!SA_PATH || !KEY_PATH) {
  console.error('\nUsage: node scripts/full-launch-audit.js <service-account.json> <stripe-readonly-key.txt>');
